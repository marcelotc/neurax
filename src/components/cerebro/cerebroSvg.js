...
const CerebroSvg = () => {
    ...
    return (
        ...
        >
            ...
            >
                <Path onPress={() => alert('Lobo Frontal')} fill={nivelFrontal} d="M280.5 34L288 26.5L302 13.5L270 7L244.5 17.5L227.5 13.5H196.5L169 26.5L148 41H127.5L102.5 49.5L83.5 70.5L52 88L39.5 112L33.5 131L22.5 139L6 171.5V193L13.5 223V244.5L30.5 269L66 281.5L77.5 292L96.5 298H119.5L127.5 304L135 308.5H148H169L196.5 292L207.5 285.5L215.5 278L221 269V259.5L252 152V146.5H262.5H270H278H286.5L292 142.5V133L286.5 123L278 112L270 102.5L264.5 93.5L262.5 81V67L270 49.5L280.5 34Z" stroke="#231F20" strokeWidth="12" />
                ...
                <Path onPress={() => alert('Lobo Parietal')} fill={nivelParietal} d="M264.5 161H310L461.5 139.5L481 129L496 122.5L487.5 94.5L481 74L461.5 58L442 50.5H427L418.5 37.5L397 20H367H330.5H310L292.5 30L281 37.5L271 58L264.5 86L281 116V129L292.5 139.5V146L259 161" stroke="#231F20" strokeWidth="16" />
                ...
                <Path onPress={() => alert('Lobo Occipital')} fill={nivelOccipital} d="M407 282.5L422.5 149L463 142L499.5 131L508 149V164.5L499.5 181.5L508 202.5V230.5L499.5 260L488.5 282.5H468.5L433.5 296.5H407V282.5Z" stroke="#231F20" strokeWidth="16" />
                <Path d="M425.476 208.713L456.486 189.107L433.872 215.821L422.066 227.445L409 228.176L425.476 208.713Z" fill="#231F20" stroke="#231F20" />
                <Path onPress={() => alert('Lobo Temporal')} fill={nivelTemporal} d="M228.5 276L258 158H411V209L401.5 276V294.5V305.5L366 324H325.5V334H296L258 324L248.5 312.5H224.5L205 305.5H193.5L205 294.5L228.5 276Z" stroke="#231F20" strokeWidth="16" />
                <Path d="M339 187L350 152V187L348.5 203.5L339 212.5V187Z" fill="#231F20" stroke="#231F20" />
                <Path d="M316.476 223.713L347.486 204.107L324.872 230.821L313.066 242.445L300 243.176L316.476 223.713Z" fill="#231F20" stroke="#231F20" />
