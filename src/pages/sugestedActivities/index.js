...
const sugestedActivities = (props) => {
    ...
    randomActivities.forEach((elem) => {
        randomActivitiesArray.push(elem.activities)
    })
    const [selectedActivity, setSelectedActivity] = useState(Array(randomActivitiesArray.length).fill(false)) //Array.from({ length: activitiesObject.length }, _ => false)
        ...
        <View style={styles.container}>
            ...
            <ScrollView style={styles.questionsContainer}>
                <View style={styles.tags}>
                    {randomActivitiesArray.map((data, i) => (
